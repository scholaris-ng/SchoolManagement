...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Every colour resolves through a CSS variable so a school's branding
        // (primary colour, accent) can be swapped at runtime without a rebuild.
      ...
      boxShadow: {
        ...
        popover: '0 4px 6px -1px rgb(0 0 0 / 0.08), 0 10px 24px -4px rgb(0 0 0 / 0.12)',
      },
    },
  },
  plugins: [],
