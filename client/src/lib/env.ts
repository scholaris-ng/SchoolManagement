...
/** Mocks are a development affordance and must never ship to production. */
const mockingAllowed = !raw.PROD;
...
export const env = {
  ...
  useMockApi: mockingAllowed && raw.VITE_USE_MOCK_API,
  useMockAuth: mockingAllowed && raw.VITE_USE_MOCK_AUTH,
  firebase: {
