...
import { deliverySummary } from './receipt-delivery-log';
import type { ReceiptDelivery } from '@/types/finance';

function delivery(overrides: Partial<ReceiptDelivery> = {}): ReceiptDelivery {
  return {
    id: 'del-1',
    paymentId: 'pay-1',
    channel: 'EMAIL',
...
describe('deliverySummary', () => {
  it('says a receipt has not gone out when nothing has been logged', () => {
   ...
   * send somebody to re-send a receipt already sitting on the printer — but it
